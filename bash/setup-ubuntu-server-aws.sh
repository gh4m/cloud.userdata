...
## home host setup
HOME_ISP_INTERNET_IP_ADDR=$(dig +short ${HOME_ISP_INTERNET_FQDN} | tail -n1 | grep -E -o "^([0-9]{1,3}[\.]){3}[0-9]{1,3}$")
echo "${HOME_ISP_INTERNET_IP_ADDR} ${HOME_ISP_INTERNET_FQDN}" >> /etc/hosts
